...
/**
 * OG image dinâmica 1200x630 — usada por WhatsApp, Twitter/X, Discord,
 * Slack, Telegram, LinkedIn, Facebook. Renderiza HTML/CSS no edge via
 * @vercel/og e devolve PNG.
 *
 * Crawlers (WhatsApp, X) NÃO suportam SVG no og:image — por isso
 * precisamos gerar PNG mesmo. Cacheado pelo Cloudflare na frente.
 */
...
export default async function OGImage() {
  return new ImageResponse(
    (
      ...
      >
        {/* Vermelho rail no topo (assinatura visual Arasaka) */}
        <div
          style={{
            position: 'absolute',
            top: 0,
        ...
        {/* Bracket cantos (estilo terminal cyberpunk) */}
        <div
          style={{
            position: 'absolute',
            top: '28px',
        ...
        >
          {/* Mark Arasaka redesenhado em SVG inline (compatível com ImageResponse) */}
          <svg
            width="120"
            height="120"
            viewBox="0 0 64 64"
